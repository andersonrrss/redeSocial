...
const name_or_email = document.querySelector("#name-or-email") as HTMLInputElement
const name_email_MSG = document.querySelector("#emailNameMSG") as HTMLSpanElement
...
loginForm.addEventListener("submit", function(event){
    ...
    const sing_btn = document.querySelector("#sing_button") as HTMLButtonElement
    const senha_input = document.querySelector("#password") as HTMLInputElement
    const senha_div = document.querySelector("#divSenha") as HTMLDivElement
